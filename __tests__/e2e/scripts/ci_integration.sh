...
##################################################
STACK_VERSION=$1 SYNTHETICS_JUNIT_FILE="junit_$1.xml" npx @elastic/synthetics synthetics.journey.ts synthetics_api.journey.ts --reporter junit $SYNTHETICS_E2E_ARGS
